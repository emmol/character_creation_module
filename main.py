...
# Количество урона стандартной атаки.
DEFAULT_ATTACK = 5
# Стандартное значение защиты.
DEFAULT_DEFENCE = 10
# Стандартный уровень выносливости
DEFAULT_STAMINA = 80


class Character:
    # Переменная описания класса
    BRIEF_DESC_CHAR_CLASS = 'отважный любитель приключений'
    # Диапазон значений очков урона атаки.
    RANGE_VALUE_ATTACK = (1, 3)
    # Диапазон значений защиты.
    RANGE_VALUE_DEFENCE = (1, 5)
    # Значение очков урона для специального умения.
    SPECIAL_BUFF = 15
    ...
    def attack(self):
        ...
        value_attak = DEFAULT_ATTACK + randint(*self.RANGE_VALUE_ATTACK)
        return (f'{self.name} нанес противнику урон, равный '
                f'{value_attak}')
    # Объявляем метод защиты

    def defence(self):
        # Вычисляем значение защиты.
        value_defence = DEFAULT_DEFENCE + randint(*self.RANGE_VALUE_DEFENCE)
        return (f'{self.name} блокировал {value_defence} ед. урона.')

    # Объявляем метод специального умения
    def special(self):
        # Описываем метод специальной атаки
        return (f'{self.name} применил специальное умение '
                f'"{self.SPECIAL_SKILL} {self.SPECIAL_BUFF}"')

    # Метод описания класса персонажа
    def __str__(self):
...
def start_training(character):
    ...
    """
    # Словарь ввода действия персонажа.
    commands = {
...
def choice_char_class(char_name: str) -> Character:
    ...
    while approve_choice != 'y':
        ...
        # Выводим в терминал описание персонажа.
        print(char_class)
